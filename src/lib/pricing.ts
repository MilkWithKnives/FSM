...
export const serviceRates: ServiceRate[] = [
 ...
 { id: 'drone', name: 'Aerial Drone Photos', path: '/drone', price: 160, inclusions: ['Aerial property photography', '24-hour delivery'], qualifier: 'Additional fees above 20 acres.', inquireOnly: false },
