	...
	<div class="drawer-content flex flex-col min-h-screen">
		...
		<nav class="navbar fixed top-0 z-50 bg-white border-b border-gray-100 px-3 lg:px-8 h-16 min-h-[4rem]">
			...
			<div class="navbar-start">
				...
				<a href="/real-estate-photography" class="hidden lg:flex items-center gap-3" aria-label="Full Scope Media LLC">
			...
			<div class="navbar-center">
				...
				<a href="/real-estate-photography" class="lg:hidden" aria-label="Full Scope Media LLC">
		...
		<footer class="bg-white border-t border-gray-100 py-12 lg:py-16 px-6 lg:px-20">
			<div class="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-10">
				<div class="col-span-2 md:col-span-1">
					<a href="/real-estate-photography" class="flex items-center gap-3 mb-4">
...
<li><a href="/drone" class="text-sm text-gray-600 hover:text-black transition-colors">Aerial Drone</a></li>
				...
				<div>
					...
					<a href="tel:+19895257768" class="text-sm text-gray-600 hover:text-black transition-colors block">(989) 525-7768</a>
	...
	<div class="drawer-side z-[60]">
		...
		<div class="bg-white min-h-full w-[280px] p-6 flex flex-col">
			<div class="flex justify-between items-center mb-8">
				<a href="/real-estate-photography" class="flex items-center gap-3" aria-label="Full Scope Media LLC" onclick={closeMenu}>
			...
			<ul class="flex flex-col gap-5">
				<li><a href="/portfolio" class="text-base tracking-wider text-gray-800" onclick={closeMenu}>Portfolio</a></li>
				<li>
...
<li><a href="/drone" class="text-sm tracking-wider text-gray-700" onclick={closeMenu}>Aerial Drone</a></li>
				...
				<li><a href="/pricing" class="text-base tracking-wider text-gray-800" onclick={closeMenu}>Pricing</a></li>
				<li><a href="/faq" class="text-base tracking-wider text-gray-800" onclick={closeMenu}>FAQ</a></li>
				<li><a href="/about" class="text-base tracking-wider text-gray-800" onclick={closeMenu}>About</a></li>
				<li><a href="/journal" class="text-base tracking-wider text-gray-800" onclick={closeMenu}>Journal</a></li>
